        ...
        <>
            ...
            <section className="relative min-h-screen flex items-center justify-center">
                ...
                <div className="relative max-w-4xl mx-auto text-center px-6">
                    ...
                    <h1 className="text-5xl sm:text-7xl font-extrabold text-custom-blue mb-6 mt-32 md:mt-0">
                        Oxford Blue Laundry <br />
                        <span className="text-custom-blue font-semibold italic text-4xl">- do other things</span>
                    </h1>
